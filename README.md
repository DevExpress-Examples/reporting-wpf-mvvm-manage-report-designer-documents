<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/417404860/2021.2)
...
<!-- default badges end -->
# How to Use MVVM Framework to Create Custom Commands for Report Designer
